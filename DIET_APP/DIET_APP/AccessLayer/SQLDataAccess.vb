...
Public Module Singleton
    ...
    Public Function ConnectSAPCompany(ByVal strCompanyDB As String, ByVal strSAPUserName As String, ByVal strSAPPwd As String) As SAPbobsCOM.Company
        ...
        Try
            ...
            Dim IsCloud As String = System.Configuration.ConfigurationManager.AppSettings("IsCloud").ToString()
            ...
            ElseIf (ServerType = "2012") Then
                _retVal.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_MSSQL2012
            ElseIf (ServerType = "2014") Then
                _retVal.DbServerType = SAPbobsCOM.BoDataServerTypes.dst_MSSQL2014
            End If
