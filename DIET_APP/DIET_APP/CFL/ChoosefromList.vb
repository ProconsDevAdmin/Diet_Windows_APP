...
#Region "Events"
    ...
    Private Sub itemCfl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cflFind.Focus()
            cflFind.Select()
            If oFilterText.Length > 0 Then
                cflFind.Text = oFilterText
            End If
    ...
    Private Sub frmCFL_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
